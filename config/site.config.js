...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'like@gxian.onmicrosoft.com',
  ...
  title: "Like's OneDrive",

  // The folder that you are to share publicly with onedrive-vercel-index. Use '/' if you want to share your root folder.
  baseDirectory: '/Public1',
  ...
  email: 'mailto:like@gxian.onmicrosoft.com',
